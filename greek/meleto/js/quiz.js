...
function checkAnswer() {
  ...
  if ($.inArray(answer, question.answer) !== -1) {
    canErase = false;
    $("#result").html('<img src="/img/icons/checkmark.png" alt="check">');
    ...
    canErase = false;
    $("#result").html('<img src="/img/icons/warning.png" alt="warning">');
    $("#nextQuestion").addClass("hidden");
  } else {
    canErase = true;
    $("#result").html('<img src="/img/icons/eraser.png" alt="erase">');
    $("#nextQuestion").addClass("hidden");
  }
}
